...
public class RGB0E05And01To4ColorLightAdapter extends RecyclerView.Adapter {
    Context mContext;
    ...
    static /* synthetic */ OnItemClickListener access$000(RGB0E05And01To4ColorLightAdapter rGB0E05And01To4ColorLightAdapter) {
        return rGB0E05And01To4ColorLightAdapter.mListener;
    }
    ...
    public RGB0E05And01To4ColorLightAdapter(Context context) {
        this.mContext = context;
    }

    public RGB0E05And01To4ColorLightAdapter() {
    }
    ...
    class 1 implements View.OnClickListener {
        ...
        public void onClick(View view) {
            RGB0E05And01To4ColorLightAdapter.access$000(RGB0E05And01To4ColorLightAdapter.this).onItemClick(this.val$position);
        }
    }
